...
class TD3Agent(ContinuousOffPolicyAgent):
    ...
    def __init__(self,
        ...
        td3_specific_config = {'name': 'TD3Agent', 'critic_lr': critic_lr, 'actor_lr': actor_lr,
    ...
    def _learn(self) -> dict:
        ...
        with torch.no_grad():
            ...
            q_target = reward + ~done * self.discount * torch.min(q1_next, q2_next)
